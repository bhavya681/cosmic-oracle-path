  ...
  return (
    <section
      className="
        ...
        bg-[#100826]  /* Deep dark indigo background, best for dark theme */
        dark:bg-[#080310]
    ...
    >
      {/* Mystical multi-layered cosmic/astrological background */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        {/* Nebula-like glow (dark purple-centric for dark mode) */}
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="font-heading text-[2.6rem] md:text-6xl font-bold mb-6 text-indigo-100/90 drop-shadow-lg flex items-center justify-center gap-4 tracking-widest">
            <span className="relative flex items-center justify-center">
              <Hand className="w-12 h-12 text-violet-500 animate-pulse drop-shadow-glow" />
              <span className="absolute -bottom-1 right-1 text-yellow-300/70 text-lg animate-spin-slow">★</span>
            </span>
            Sacred Palmistry & Astrology
            <span className="relative flex items-center justify-center">
              <Sparkles className="w-12 h-12 text-fuchsia-400 animate-pulse drop-shadow-glow" />
              <span className="absolute -top-1 left-1 text-fuchsia-200/90 text-lg animate-pulse-slow">✧</span>
            </span>
          </h2>
          <p className="font-body text-lg md:text-xl text-indigo-200/80 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <Card className="p-8 bg-gradient-to-br from-[#110a23]/80 via-[#1d0c27]/75 to-[#1c103b]/50 backdrop-blur-md border-fuchsia-300/30 shadow-[0_7px_36px_-4px_rgba(40,11,55,0.21)] relative overflow-hidden ring-1 ring-fuchsia-400/15">
            ...
            <div className="relative aspect-[3/4] bg-gradient-to-br from-[#16132b]/90 via-[#2b113e]/60 to-[#26114b]/25 rounded-3xl overflow-hidden shadow-[inset_0_4px_30px_rgba(18,7,41,0.19)] border-2 border-violet-300/20 ring-2 ring-indigo-600/10">
              {/* Celestial halo glow */}
              ...
              {palmLines.map((line) => (
                ...
                >
                  ...
                  />
                  {hoveredLine === line.id && (
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-[#231940]/95 via-[#200931]/95 to-[#191237]/95 px-3 py-1 rounded-xl border border-fuchsia-400/30 shadow-cosmic whitespace-nowrap">
                      <p className="text-xs font-semibold text-indigo-100 drop-shadow-glow">{line.name}</p>
                    </div>
                  )}
                </div>
              ))}
            ...
            <div className="mt-7 text-center space-y-2">
              <p className="text-sm text-violet-200 italic flex items-center justify-center gap-2">
                <span className="text-fuchsia-200 animate-pulse-slow text-xl">☉</span>
                Hover or tap the mystical palm lines &nbsp;
          ...
          <div className="space-y-6">
            {!selectedLine ? (
              <Card className="p-8 bg-gradient-to-bl from-[#3e1452]/40 via-[#16113b]/60 to-[#060211]/80 backdrop-blur-sm border-fuchsia-400/20 shadow-[0_2px_14px_0_rgba(71,27,124,0.15)] animate-fade-in">
                <div className="text-center space-y-4">
                  <span className="relative block w-16 h-16 mx-auto">
                    ...
                    <Sparkles className="w-16 h-16 mx-auto text-fuchsia-200 animate-pulse relative z-10" />
                  </span>
                  <h3 className="font-heading text-2xl font-bold text-fuchsia-100 drop-shadow-glow">
                    Select a Palm Line
                  </h3>
                  <p className="font-body text-violet-200/80">
                    Click a line in the cosmic palm to reveal its sacred astrology & palmistry wisdom for your destiny path.
                  </p>
                </div>
              </Card>
            ) : (
              <Card className="p-8 bg-gradient-to-br from-[#191237]/85 via-[#240d37]/90 to-[#331752]/20 backdrop-blur-sm border-fuchsia-400 shadow-cosmic animate-scale-in">
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    <div 
                      className={`w-12 h-12 ${selectedLine.color} rounded-full animate-pulse shadow-glow ring-2 ring-fuchsia-200/20`}
                    />
                    <div>
                      <h3 className="font-heading text-2xl font-bold text-fuchsia-100">
                        {selectedLine.name}
                      </h3>
                      <p className="text-sm text-indigo-200/70">Astropalmistry Wisdom</p>
                    </div>
                  </div>

                  <div className="h-px bg-gradient-to-r from-indigo-400 via-fuchsia-400 to-amber-200/30" />

                  <div className="p-6 bg-gradient-to-t from-[#32123f]/30 via-[#181025]/40 to-[#1a1841]/10 rounded-xl border border-fuchsia-200/10 shadow-md ring-1 ring-indigo-900/5">
                    <p className="font-body text-lg text-indigo-100/90 leading-relaxed">
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-fuchsia-400 via-violet-600 to-fuchsia-600 hover:from-fuchsia-300 hover:to-violet-400 text-white font-semibold py-6 rounded-full shadow-glow transition-all duration-500 hover:scale-105 outline-none ring-2 ring-fuchsia-400/30"
                  >
            ...
            <Card className="p-6 bg-gradient-to-br from-[#191237]/80 via-[#1d0c27]/80 to-[#1c103b]/10 backdrop-blur-sm border-violet-200/15">
              <h4 className="font-heading text-lg font-bold text-fuchsia-200 mb-4 tracking-wide flex items-center gap-2">
              ...
              <div className="space-y-3">
                {palmLines.map((line, i) => (
                  <button
                    key={line.id}
                    onClick={() => setSelectedLine(line)}
                    className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all duration-300 shadow-[0_0_9px_0_rgba(168,139,250,0.09)] ${
                  ...
                  >
                    <div className={`w-3 h-3 ${line.color} rounded-full drop-shadow-glow`} />
                    <span className="font-body text-sm font-medium text-indigo-100">
                      {line.name}
                    </span>
                    <span className="ml-auto text-fuchsia-300 text-lg">{ASTRO_SYMBOLS[i]}</span>
                  </button>
                ))}
              </div>
            </Card>
