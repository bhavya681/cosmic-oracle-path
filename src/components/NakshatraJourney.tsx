...
const nakshatras = [
  ...
  { name: 'Uttara Phalguni', symbol: '☀️', deity: 'Aryaman', wisdom: 'The sun of patronage illuminates your path with generosity and partnership. You build lasting unions and beneficial agreements.' },
  ...
  { name: 'Jyeshtha', symbol: '☂️', deity: 'Indra', wisdom: 'The king of gods crowns you with authority and protective power. You rise to prominence through courage and commanding presence.' },
  ...
  { name: 'Uttara Ashadha', symbol: '🏔️', deity: 'Vishvedevas', wisdom: 'The universal gods grant you lasting achievement and righteous victory. Your efforts create permanent positive change in the world.' },
  ...
  { name: 'Purva Bhadrapada', symbol: '⚔️', deity: 'Aja Ekapada', wisdom: 'The one-footed goat carries you toward spiritual fire and transformation. Your intensity and determination burn away all obstacles.' },
